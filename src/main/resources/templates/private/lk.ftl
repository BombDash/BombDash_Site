...
<@page.page locale.__("personal_area")>
    <div class="mx-0 row">
        <div class="textTransfer p-3 w-100  mb-3 bg-secondary rounded">
            <span class="profileName"><@page.balance bombDashUser.getBalance() /></span>
            <a href="/balance" class="profile-button btn btn-success" role="button" aria-pressed="true">Пополнить
                баланс</a>
        </div>
    </div>
    <div class="mx-0 row">
        <div id="button-panel" class="col-lg-3 mr-lg-3 mb-3 mb-lg-0 rounded bg-secondary">
            <#if info.getStatus() != "user">
                <a href="#server">
